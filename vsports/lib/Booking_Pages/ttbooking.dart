...
class Tabletennis extends StatefulWidget {
  var regno;
  Tabletennis({super.key, this.regno});
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => Tabletennisconfirmbooking(regno: widget.regno,rq: rq,tt: tt,)));
                },
