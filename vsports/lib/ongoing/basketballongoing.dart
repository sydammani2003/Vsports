...
class Basketballongoingpage extends StatefulWidget {
  Basketballongoingpage({super.key});

  @override
  State<Basketballongoingpage> createState() => _BasketballongoingpageState();
}

class _BasketballongoingpageState extends State<Basketballongoingpage> {
  @override
