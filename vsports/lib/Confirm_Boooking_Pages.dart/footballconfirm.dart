...
class Footballconfirmbooking extends StatefulWidget {
  var regno;
  var balls;
  var tt;
  Footballconfirmbooking({super.key, this.regno, this.balls, this.tt});

  @override
  State<Footballconfirmbooking> createState() => _FootballconfirmbookingState();
}

class _FootballconfirmbookingState extends State<Footballconfirmbooking> {
  footbook(ball, regno) async {
    try {
      ...
      var response = await ioClient.post(
        Uri.parse(
            'https://${ngrok_link}/api/book_football/'),
        body: {'reg_no': regno.toString(), 'no_of_balls': ball.toString()},
      );

      var data = jsonDecode(response.body);
      if (data['message'] == 'Football booking successful!') {
            ...
            children: [
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    footbook(widget.balls, widget.regno);
                  },
