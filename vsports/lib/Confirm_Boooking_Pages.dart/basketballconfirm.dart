...
class Basketballconfirmbooking extends StatefulWidget {
  var balls;
  var tt;
  var regno;
  Basketballconfirmbooking({super.key, this.regno, this.balls, this.tt});

  @override
  State<Basketballconfirmbooking> createState() =>
      _BasketballconfirmbookingState();
}

class _BasketballconfirmbookingState extends State<Basketballconfirmbooking> {
  basketbook(ball, regno) async {
    try {
      ...
      var response = await ioClient.post(
        Uri.parse('https://${ngrok_link}/api/book_basketball/'),
        body: {'reg_no': regno.toString(), 'no_of_balls': ball.toString()},
      );

      var data = jsonDecode(response.body);
      if (data['message'] == 'Basketball booking successful!') {
            ...
            children: [
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    basketbook(widget.balls, widget.regno);
                  },
