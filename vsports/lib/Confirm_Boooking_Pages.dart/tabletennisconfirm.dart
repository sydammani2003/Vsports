...
class Tabletennisconfirmbooking extends StatefulWidget {
  var regno;
  var rq;
  var tt;
  Tabletennisconfirmbooking({super.key, this.regno, this.rq, this.tt});

  @override
  State<Tabletennisconfirmbooking> createState() =>
      _TabletennisconfirmbookingState();
}

class _TabletennisconfirmbookingState extends State<Tabletennisconfirmbooking> {
  ttbook(rq, regno) async {
    try {
      ...
      var response = await ioClient.post(
        Uri.parse(
            'https://${ngrok_link}/api/book_cricket/'),
        body: {'reg_no': regno.toString(), 'no_of_bats': rq.toString()},
      );

      var data = jsonDecode(response.body);
      if (data['message'] == 'CricketBooking booking successful!') {
